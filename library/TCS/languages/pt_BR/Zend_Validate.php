...
return array(
    ...
    "Invalid type given, value should be a string"										=> "O tipo especificado é inválido, o valor deve ser uma string",
    "'%value%' is no valid email address in the basic format local-part@hostname" 		=> "Digite um endereço de E-mail Válido.",
	...
	"Value is required and can't be empty" => "Campo Obrigátorio",
	...
	"'%value%' is not a valid email address in the basic format local-part@hostname"=> "Formato Inválido",
);