...
class TCS_Form_FormFornecedorCombustivel extends Zend_Form {
    ...
    public function init() {
        ...
        $this->setAction('');
        $this->setMethod('post');
        $this->setAttribs(array('id' => 'FormFornecedorCombustivel', 'name' => 'FormFornecedorCombustivel'));
        ...
        $elemento = $this->createElement('text', 'cidade', array('label' => 'Cidade/UF', 'id' => 'cidade', 'class' => 'form-control'));
        $this->addElement($elemento);
        ...
        $this->addElement($elemento);
        $this->addDisplayGroup(array('id', 'nome', 'endereco', 'cidade', 'telefone', 'ativo', 'Salvar'), 'fornecedor-combustivel', array('removeDecorator' => 'Label'));
