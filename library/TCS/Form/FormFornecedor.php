...
class TCS_Form_FormFornecedor extends Zend_Form {
    ...
    public function init() {
        ...
        $this->setAction('');
        $this->setMethod('post');
        $this->setAttribs(array('id' => 'FormFornecedor', 'name' => 'FormFornecedor'));
        ...
        $this->addElement($elemento);
        $this->addDisplayGroup(array('id', 'nome', 'endereco', 'cidade', 'telefone', 'ativo', 'Salvar'), 'fornecedor', array('removeDecorator' => 'Label'));
