...
class Admin_FornecedoresCombustivelController extends Zend_Controller_Action {

    public function indexAction() {
        $Model = new Admin_Model_FornecedoresCombustivel();
        $result = $Model->Lista();
        $this->view->dados = $result;
    }

    public function adicionarAction() {
        $form = new TCS_Form_FormFornecedorCombustivel();
        $Model = new Admin_Model_FornecedoresCombustivel();
    ...
    public function excluirAction() {
        ...
        $this->_redirect('admin/fornecedorescombustivel');
    }
